...
describe("<App />", () => {
  describe("Displays correct text on screen", () => {
  ...
  describe("Displays corrected number of rows on screen", () => {
  ...
  describe("Displays correct classNames", () => {
  ...
  describe("Changes initial state after user interaction", () => {
